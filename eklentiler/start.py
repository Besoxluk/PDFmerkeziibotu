...
async def start_command(client: Client, message: Message):
    ...
    if len(text) > 7:
        ...
        buttons = [
            [InlineKeyboardButton("• Bot Hakkinda🔧 •", callback_data="about")],
            [
                InlineKeyboardButton("Kanal 1", url=client.invitelink),
                InlineKeyboardButton("Kanal 2", url=client.invitelink2),
            ],
            [
...
async def not_joined(client: Client, message: Message):
    buttons = [
        [
            InlineKeyboardButton("⬆️Usteki Kanalara", url=client.invitelink),
            InlineKeyboardButton("Uye ol⬆️", url=client.invitelink2),
        ],
    ]
    try:
        buttons.append(
